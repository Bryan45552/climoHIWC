...
print "$callsign\n\n\n\n";
	...
	#$website="https://cli-dap.mrcc.illinois.edu/station/KP58/";
	...
	open(QC, ">$qcFile") or die "Can't open";
		...
		$websiteData='' .$website.'/data?start='.$startDat.'&end='.$endDat.'&elem=AVA&elem=DEW&elem=MWS';

		#$websiteData="https://cli-dap.mrcc.illinois.edu/station/KP58/data?start=$startDat&end=$endDat&elem=AVA&elem=DEW&elem=MWS";
